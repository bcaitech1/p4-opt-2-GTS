...
def get_nas_model(cfg, activation_func, model_path):
...
class Torch2tflite:
    def __init__(self, model_cfg, activation_func, model_path, label_path, save_path, model_name, image_size = 224):
        ...
        self.pytorch_model = get_nas_model(model_cfg, self.activation_func, self.model_path)
    ...
    def __tfliteMetadata(self):
        ...
        # Standard : Imagenet
        _INPUT_NORM_MEAN = [0.485*255, 0.456*255, 0.406*255]
        _INPUT_NORM_STD = [0.229*255, 0.224*255, 0.225*255]
...
if __name__=="__main__":
    ...
    parser.add_argument("--model_cfg", type=str, default="./configs/model/example.yaml", help="set model config file path")
    parser.add_argument("--model_path", type=str, default="./pytorch_model/example.pth", help="set saved model weight file path")
