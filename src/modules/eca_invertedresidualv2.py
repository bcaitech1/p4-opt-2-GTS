...
class ECAInvertedResidualv2(nn.Module):
    ...
    def __init__(self, inp, oup, stride, expand_ratio, norm_layer=None):
        super(ECAInvertedResidualv2, self).__init__()
        self.stride = stride
        ...
        layers.append(eca_layer(oup, 3)) # fixed kernel_size = 3
...
class ECAInvertedResidualv2Generator(GeneratorAbstract):
